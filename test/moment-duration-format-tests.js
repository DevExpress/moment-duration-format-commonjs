...
const installFormat        = require('../');

installFormat(moment);

moment.duration.fn.format.defaults.userLocale = "en-US";

describe('moment.duration.fn.format', () => {
    ...
    it("Token length when `trim: false`", function () {
    ...
    it("Trim errors from years/months to weeks/days", function () {
    ...
    it("Left Trimmed First Token Length", function () {
    ...
    it("Right Trimmed First Token Length", function () {
    ...
    it("Positive Precision", function () {
    ...
    it("Output To Lesser Units", function () {
        equal(moment.duration(1, "years").format("y"), "1");
    ...
    it("Output To Greater Units", function () {
    ...
    it("Using Only Settings Argument", function () {
    ...
    it("Floating point errors", function () {
        equal(moment.duration(3.55, "hours").format("h", 1), "3.6");
    });
    
    //TODO: this test is acutally doesn't work in the Node.js environement
    it.skip("Floating point errors from Moment.js output", function () {
    ...
    it("Zero Value Duration", function () {
    ...
    it("Default Template Function", function () {
    ...
    it("Custom Template Function", function () {
    ...
    it("Negative Durations", function () {
        equal(moment.duration(-1, "years").format("y"), "-1");
        equal(moment.duration(-1, "months").format("M"), "-1");
        equal(moment.duration(-1, "weeks").format("w"), "-1");
        equal(moment.duration(-1, "days").format("d"), "-1");
    ...
    it("Negative Durations that have zero value", function () {
    ...
    it("Negative Durations with leading text", function () {
        equal(moment.duration(-42, "seconds").format("[Leading Text] s", { trim: false }), "Leading Text -42");
    });
    
    it("Negative Durations and Trimming", function () {
    ...
    it("Stop Trimming with the * Character", function () {
    ...
    it("Show only the largest `x` tokens", function () {
    ...
    it("Trim both with largest", function () {
    ...
    it("usePlural Months and Years", function () {
    ...
    it("usePlural, multiple tokens", function () {
    ...
    it("usePlural with rounding", function () {
    ...
    it("Automatic Locale-based units", function () {
    ...
    it("Automatic Locale-based time notation", function () {
    ...
    it("Locale missing durations labels", function () {
        moment.locale('fr', {
    ...
    it("userLocale and useGrouping", function () {
    ...
    it("useSignificantDigits", function () {
    ...
    it("useSignificantDigits and trunc", function () {
    ...
    it("useSignificantDigits and trim: false", function () {
    ...
    it("Documentation examples", function () {
    ...
    it("Pluralize singular unit labels", function () {
    ...
    it("stopTrim", function () {
        equal(moment.duration(2, "hours").format("y [years], d [days], h [hours], m [minutes], s [seconds]", { trim: "both", stopTrim: ["d", "m"] }), "0 days, 2 hours, 0 minutes");
    });
    
    it("Milliseconds token length === 2", function () {
    ...
    it("Remove leading/trailing space, comma, colon, dot", function () {
        equal(moment.duration(1, "second").format(".s "), "1");
        equal(moment.duration(1, "second").format(":s,"), "1");
    });
    
    it("Invalid durations", function () {
        equal(moment.duration(NaN, "seconds").format(), "0 seconds");
        equal(moment.duration(NaN, "years").format("y"), "0");
    });
    
    it("Custom Locale labels, label types, pluralizer", function () {
    ...
    it("Custom Locale Pluralizer Only", function () {
        // Borowing moment's "fr" locale.
    ...
    it("Custom Locale Standard Labels Only", function () {
        // Borowing moment's "fr" locale.
    ...
    it("Custom Locale Label Types Only", function () {
        // Borowing moment's "fr" locale.
    ...
    it("Rounded value bubbling", function () {
    ...
    it("forceFormatFallback", function () {
...
describe('moment.duration.format', () => {    
    it("Basic Use", function () {
    ...
    it("maxValue, negative durations", function () {
        deepEqual(moment.duration.format([
            moment.duration(-61, "seconds"),
            moment.duration(-59, "seconds"),
            moment.duration(-1.1, "minutes"),
    ...
    it("minValue, negative durations", function () {
        deepEqual(moment.duration.format([
            moment.duration(-1, "seconds"),
            moment.duration(-59, "seconds"),
            moment.duration(-59.9999, "seconds"),
    ...
    it("Mixed positive and negative durations", function () {
        deepEqual(moment.duration.format([
            moment.duration(-1, "seconds"),
            moment.duration(-3599, "seconds"),
    ...
    it("userLocale, usePlural, useGrouping, useLeftUnits", function () {
        deepEqual(moment.duration.format([
            moment.duration(1000, "seconds"),
            moment.duration(3600, "seconds"),
            moment.duration(10000, "seconds"),
